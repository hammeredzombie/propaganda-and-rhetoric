# Propaganda and Rhetoric — The Proper Goose

The source for **The Proper Goose**, a fictional online publication
...
> *The Proper Goose. Take a Gander at the daily News.*
...
- **GSAP / PixiJS** — installed but unused on day one. The
  `fx/` state machine can drive them from registered animations —
  see [`fx/README.md`](./fx/README.md).
...
- The Proper Goose is a fictional publication. No real outlet names,
