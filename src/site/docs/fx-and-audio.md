...
1. Drop an audio file in `assets/audio/`. MP3 or OGG, 96–128 kbps
...
A single audio file with multiple regions. Usually fastest path
because you make all SFX in one DAW session and export once.
