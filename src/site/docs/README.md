...
Map of the docs. Each file is scoped to one subsystem so you can
jump in at 2am and not have to scroll.
...
See also:
- [`../README.md`](../README.md) — site quickstart
- [`../../../CLAUDE.md`](../../../CLAUDE.md) — monorepo overview (site + Godot game split)
